...
#ifndef PROJECT_pcl_in_bbox_H
#define PROJECT_pcl_in_bbox_H

#define __APP_NAME__ "pcl_in_bbox"
...
class ROSPixelCloudFusionApp
{
	...
	void SyncedCallback(const sensor_msgs::PointCloud2::ConstPtr &in_cloud_msg,
